...
const sampleData: SchemeData[] = [
  {
    ...
    type: 'government',
    pdfUrl: 'https://www.nwm.gov.in/sites/default/files/Revised-Mission_Document-NWM.pdf',
  ...
  },
  {
    ...
    type: 'government',
    pdfUrl: 'https://ejalshakti.gov.in/JSA/jsaContent/GuidelinesforJalShaktiAbhiyan.pdf',
  ...
  },
  {
    ...
    type: 'ngo',
    pdfUrl: 'https://www.wateraid.org/in/sites/g/files/jkxoof336/files/wateraid-india-country-strategy-2016-2021.pdf',
  ...
  },
  {
    ...
    type: 'government',
    pdfUrl: 'https://ataljal.hid.gov.in/assets/PDF/Atal_Bhujal_Yojana_Program_Guidelines.pdf',
  ...
  },
  {
    ...
    type: 'ngo',
    pdfUrl: 'https://www.waterforpeopleindia.org/wp-content/uploads/2021/03/module-on-water.pdf',
  ...
  },
  {
    ...
    type: 'government',
    pdfUrl: 'https://static.pib.gov.in/WriteReadData/specificdocs/documents/2025/mar/doc202537514801.pdf',
